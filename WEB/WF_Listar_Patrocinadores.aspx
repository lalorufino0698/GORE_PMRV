...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="margin-left: 200px">
        ...
        <asp:GridView ID="gv_Tabla_Lista_Patrocinadores" runat="server" OnRowCommand="gv_Tabla_Lista_Patrocinadores_RowCommand" OnPageIndexChanging="gv_Tabla_Lista_Patrocinadores_PageIndexChanging" EmptyDataText="Aun no hay ningun Patrocinador" CssClass="table-condensed table-hover" Width="95%"  AutoGenerateColumns="False" GridLines="None">
            <Columns>
