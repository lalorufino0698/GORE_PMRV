...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h3 style="text-align: center; color: black"><b>LISTA DE PRESTAMOS ACEPTADOS</b></h3>
    ...
    <div style="margin-left: 50px">
        ...
        <asp:GridView ID="gv_Tabla_Lista_Prestamo_Aceptados" runat="server" OnRowCommand="gv_Tabla_Lista_Prestamo_Aceptados_RowCommand" OnPageIndexChanging="gv_Tabla_Lista_Prestamo_Aceptados_PageIndexChanging" EmptyDataText="No hay Prestamos aceptados" CssClass="table-condensed table-hover" Width="95%" AutoGenerateColumns="False" GridLines="None" OnRowDataBound="gv_Tabla_Lista_Prestamo_Aceptados_RowDataBound">
            <Columns>
