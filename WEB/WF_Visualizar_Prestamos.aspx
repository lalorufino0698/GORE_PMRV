...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="margin-left: 200px">
        ...
        <asp:GridView ID="gv_Tabla_Lista_Prestamos" runat="server" OnRowCommand="gv_Tabla_Lista_Prestamos_RowCommand" OnPageIndexChanging="gv_Tabla_Lista_Prestamos_PageIndexChanging" EmptyDataText="No hay Prestamos Registrados" CssClass="table-condensed table-hover" Width="95%" AutoGenerateColumns="False" GridLines="None" OnRowDataBound="gv_Tabla_Lista_Prestamos_RowDataBound" AllowSorting="true" OnSorting="gv_Tabla_Lista_Prestamos_Sorting">
            <Columns>
