...
!function (a, b) {
    ...
    function f(b, c, d, e) {
        e || c.css({ width: b.innerWidth(), height: b.innerHeight() });
        var f = "auto";
    ...
    var c = {
        color: "rgba(255, 255, 255, 0.8)", custom: "", fontawesome: "", image: "loading.gif", maxSize: "100px", minSize: "20px", resizeInterval: 0, size: "50%"
    };
    ...
    a.LoadingOverlay = function (b, f) {
        switch (b.toLowerCase()) {
            case "show": var g = a.extend(!0, {}, c, f); d("body", g); break;
            case "hide": e("body", f)
        }
    },
    a.fn.LoadingOverlay = function (b, f) {
        switch (b.toLowerCase()) {
            case "show": var g = a.extend(!0, {}, c, f); return this.each(function () { d(this, g) });
            case "hide": return this.each(function () { e(this, f) })
        }
    }
}(jQuery);